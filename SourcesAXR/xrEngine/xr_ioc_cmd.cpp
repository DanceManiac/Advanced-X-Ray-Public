...
ENGINE_API Fvector4 ps_ssfx_rain_drops_setup = { 2500, 15, 0.0f, 0.0f };
...
ENGINE_API Fvector3 ps_ssfx_shadows = { 1024, 1536, 0.0f };	// LOD min res, LOD max res, -
ENGINE_API Fvector4 ps_ssfx_volumetric = { 1.0f, 1.0f, 3.0f, 1.0f }; // Force Volumetric, Vol Intensity, Vol Quality, -
...
ENGINE_API int ps_ssfx_bloom_use_presets = 0;
...
ENGINE_API Fvector4 ps_ssfx_sss_quality = { 12.0f, 4.0f, 1.0f, 1.0f }; // Dir Samples, Omni Samples, Dir Enable, Omni Enable
ENGINE_API Fvector4 ps_ssfx_sss = { 1.0f, 1.0f, 1.0f, 0.0f }; // Dir Len, Omni Len, Grass shadows, -
