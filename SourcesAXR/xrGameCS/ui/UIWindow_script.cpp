...
//				value("SLEEP_WND_PERFORM_BUTTON_CLICKED",			int(SLEEP_WND_PERFORM_BUTTON_CLICKED)),
	...
	// CUIInventroyWnd
				...
				value("INVENTORY_DETACH_GRIP_ADDON",				int(INVENTORY_DETACH_GRIP_ADDON)),
				value("INVENTORY_DETACH_GRIPV_ADDON",				int(INVENTORY_DETACH_GRIPV_ADDON)),
				value("INVENTORY_DETACH_STOCK_ADDON",				int(INVENTORY_DETACH_STOCK_ADDON)),
				value("INVENTORY_DETACH_PISTOLGRIP_ADDON",			int(INVENTORY_DETACH_PISTOLGRIP_ADDON)),
				value("INVENTORY_DETACH_HANDGUARD_ADDON",			int(INVENTORY_DETACH_HANDGUARD_ADDON))
			]
	];
}