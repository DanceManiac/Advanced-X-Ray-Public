...
void ShowHudEditor(bool& show)
{
	...
	if (item)
	{
		...
		ImGui::InputFloat3("aim_alt_hud_offset_pos 0", (float*)&item->m_measures.m_hands_offset[0][1]);
		ImGui::InputFloat3("aim_alt_hud_offset_rot 0", (float*)&item->m_measures.m_hands_offset[1][1]);
