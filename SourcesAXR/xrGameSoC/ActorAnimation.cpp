					...
					if (!m_bAnimTorsoPlayed) 
					{
					...
					else if (M)
						{
							if (is_standing)
							{
								...
								case MS_EMPTY:		M_torso = M_legs = M_head = TW->all_attack_0;	break;
								case MS_THREATEN:		M_torso = M_legs = M_head = TW->all_attack_1;	break;
							...
							else
							{
								...
								case MS_HIDING:		M_torso = TW->holster;					break;
								case MS_IDLE:		M_torso = TW->moving[moving_idx];		break;
								case MS_EMPTY:		M_torso = TW->attack_zoom;				break;
								case MS_THREATEN:		M_torso = TW->fire_idle;				break;
