--[[
WEAPON SCOPE LENS
SHADER.XR	lfo_scope_glass 
]]
function l_special  (shader, t_base, t_second, t_detail)
  shader:begin  ("lfo_scope_glass_distort","lfo_scope_glass_distort_particle")
      : sorting   (3, true)
...
function normal   (shader, t_base, t_second, t_detail)
  shader:begin    ("lfo_scope_glass_env_lq","lfo_scope_glass_env_lq")
      : fog       (true)
      : zb        (true,false)
      : blend     (true,blend.srcalpha,blend.invsrcalpha)
      : aref      (true,0)
