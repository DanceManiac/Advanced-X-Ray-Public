...
#define G_SSR_MAX_INTENSITY				0.25f	// Global reflection MAX intensity.
...
#define G_SSR_WEAPON_RAIN_FACTOR		0.5f	// Weapons reflections boost when raining ( 0 to disable ) ( Affected by rain intensity )
