...
//effect settings
#define FLICKERING_INTENSITY 0.0015		//0.0035
#define FLICKERING_FREQ 10.0			//60.0
#define NOISE_INTENSITY 0.05			//0.15
#define SCANLINES_INTENSITY 0.075		//0.175
#define VIGNETTE_RADIUS 1.0				//1.0
