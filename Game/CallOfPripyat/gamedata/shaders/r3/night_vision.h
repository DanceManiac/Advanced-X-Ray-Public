...
// NVG POSITIONING OPTIONS: in (X, Y) format. If X is 0, it's L edge of screen, if 1, it's right edge of screen. Note that it's not linear across the screen.
		...
		#define circle_radius float (10.5f)
...
// NVG CRT / NOISE VALUES
		...
		#define gen_1_nvg_noise_factor float (0.3)				// How much noise to add to NVG image (0.04 is default, anything greater than 0.15 is insane)
		...
		#define gen_2_nvg_noise_factor float (0.25)				// How much noise to add to NVG image (0.04 is default, anything greater than 0.15 is insane)
