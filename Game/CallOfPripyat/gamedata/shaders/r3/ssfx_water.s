...
shader:dx10texture	("s_perlin", "shaders\\water_perlin")
shader:dx10texture  ("s_water_ssr_noblur", "$user$ssfx_water")
	...
	shader:dx10texture	("s_nmap", "shaders\\water_normal")

	shader:dx10texture  ("s_rainsplash", "shaders\\water_sbumpvolume")
	shader:dx10texture  ("s_watercaustics", "shaders\\water_caustics")
	shader:dx10texture  ("s_wind", "shaders\\water_wind")
