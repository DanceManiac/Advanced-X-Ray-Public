...
#define G_SSR_PARALLAX_DISTANCE 		100.0f	// Max distance to render the parallax waves
...
#define G_SSR_WATER_REFLECTION_VIBRANCE 0.6f	// Reflection color vibrance ( 0 = Gray Scale ~ 1 = Full Color )

#define G_SSR_WATER_FOG_MAXDEPTH		2.0f	// Maximum visibility underwater.

#define G_SSR_WATER_SPECULAR_NORMAL		0.2f	// Specular normal intensity.
